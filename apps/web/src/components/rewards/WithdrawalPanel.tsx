      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-baseline gap-1">
            ...
            <span className="text-lg font-semibold text-slate-400">◎ SOL</span>
          </div>
        </div>
        ...
        <motion.div whileTap={{ scale: 0.98 }} className="space-y-4">
          <Button
            ...
            disabled={transactionStatus === "pending" || availableBalance === 0}
            ...
            {transactionStatus !== "idle" && (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <Badge
                    variant={
                      transactionStatus === "success" ? "default" : "secondary"
                    }
                    className={`${

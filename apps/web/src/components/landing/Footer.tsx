            ...
            <div className="max-w-7xl mx-auto">
               ...
               >
                  ...
                  <p className="text-slate-400 text-lg mb-8 max-w-2xl mx-auto">
                     Get the latest updates on network upgrades, new features,
                     and validator opportunities.
                  </p>
               ...
               >
                  ...
                  <motion.div variants={itemVariants} className="lg:col-span-2">
                     ...
                     <p className="text-slate-400 mb-6 max-w-sm">
                        Decentralized uptime monitoring powered by Solana
                        blockchain. Reliable, transparent, and
                        censorship-resistant monitoring for the modern web.
                     </p>
